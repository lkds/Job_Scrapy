...
cityList = {
        "直辖市": {
            "北京": "bj|1", "上海": "sh|2", "天津": "tj|18", "重庆": "cq|37"
        },
        "安徽": {
        ...
        "湖南": {
            ...
            "常宁": "changningshi|921",
            "祁东": "qidongxian|5690", "衡东": "hengdong|5693", "冷水江": "lengshuijiangshi|9470", "涟源": "lianyuanshi|9471",
...
for citydict in cityList.values():
    citys += citydict.values()
...
class TongchengSpider(scrapy.Spider):
    ...
    def next_request(self):
        self.curPage += 1
        if (self.curPage <= self.currentpagetotal):
